...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" show-ref "v2.13.6"
  WORKING_DIRECTORY "D:/cpp/Sci/Flow/build/_deps/catch-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/cpp/Sci/Flow/build/_deps/catch-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/cpp/Sci/Flow/build/_deps/catch-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
