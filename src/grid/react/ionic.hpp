...
namespace grid {
    namespace react {
        class ionic : public standart{
            public:
                
            inline ionic(std::shared_ptr<atom::Type> f,std::shared_ptr<atom::Type> s,std::shared_ptr<atom::Type> _to1, std::shared_ptr<atom::Type> _to2,double _maxdist,double _barrier,double _freq):standart(f,s,_to1,_to2,_maxdist,_barrier,_freq) {};
