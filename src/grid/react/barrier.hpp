...
namespace grid {
    namespace react {
        class barrier : public react{
            public:
            double barrier_height;
            double freq;
            public:
                inline barrier(std::shared_ptr<atom::Type> f,std::shared_ptr<atom::Type> s,std::shared_ptr<atom::Type> _to1, std::shared_ptr<atom::Type> _to2,double _maxdist,double _barrier,double _freq):react(f,s,_to1,_to2,_maxdist),barrier_height(_barrier),freq(_freq) {};
